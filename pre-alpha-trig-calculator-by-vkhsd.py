...
print("Please select a department: RightRatios, Sine (ratio), SineL (laws), Cosine")
departments = 'rightratios', 'sine', 'sinel', 'cosine'
func1 = input()
...
if func1 == "sine":
    ...
    while True:
        ...
        if factor1 == 'a' and factor2 == 'alpha' and unknown1 == 'c':
            ...
            print(f"This problem is impossible: Knowns = {factor1.upper()}, {factor2.upper()}; Unknowns = {unknown1.capitalize()}")
